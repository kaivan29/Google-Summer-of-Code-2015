...
evalc :: E -> Int
evalc (Const n) = n
evalc (Foldl e n l) = foldl (eval e) (evalc n) (evala l)
evalc _ = maxBound
...
eval (ConcatSum n e) = apply2 (:) (evalc n) (eval e) 
...
apply2 :: (Int -> Int -> Int) -> Int -> (Int -> Int -> Int) -> (Int -> Int -> Int)
apply2 p n q = (\x y -> sum (p n (q x y)))
